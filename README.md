...
5. Which orders had the most number of items? 
   > List of Orders with most number of items <br>
...
1. Combine the menu_items and order_details tables into a single table. 
   > Combining two tables with LEFT JOIN <br>
